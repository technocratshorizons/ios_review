...
class FaqViewController: UIViewController{
    ...
    func getfaqData() {
        ...
        print(urlRequest)
        print(userId!)
        let params =  ["user_id":userId!,"action":Cager.User.faq]as [String : Any]
        print(params)
            ...
            .responseJSON { response in
                ...
                if response.result.isSuccess
                {
                    ...
                    if item2 == 1
                    {
                        ...
                        self.faqLabel.attributedText = "\(ShortDic.value(forKey: "data") as! String)".convertHtmlText()
...
extension String{
    func convertHtmlText() -> NSAttributedString{
